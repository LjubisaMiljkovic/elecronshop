            ...
            <div className='container mx-auto flex justify-between items-center h-[100px]'>
                ...
                <div className='flex gap-7'>
                    {localStorage.hasOwnProperty('elUser') ? <div>
                        <Link to='/profile'>
                            <img src={user.image} alt="" className='w-[50px] rounded-full border border-mainYellow' />
                        </Link>
                    </div> : <div className='flex items-center gap-1'>
                        <FaUser className='text-white text-2xl cursor-pointer' />
                        <Link to='/login' className='text-white text-lg'>Sing In</Link>
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='bg-mainYellow text-white rounded-full px-[5px]'>{totalProducts ? totalProducts : 0}</span>
